    ...
    <>
      <section className="banner-homwe relative mt-4 w-full">
        <div className="relative container mx-auto flex flex-col">
          ...
          <div className="xl:w-80 xl:h-12 custom-shadow-box absolute top-64 bottom-auto left-1/2 z-50 flex h-10 w-52 -translate-x-1/2 items-center justify-center rounded-[60px] bg-white sm:top-auto sm:bottom-0 md:h-11 md:w-60 xl:bottom-[1.9rem] 2xl:h-16 2xl:w-96">
