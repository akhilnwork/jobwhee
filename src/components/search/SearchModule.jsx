...
const SearchModule = () => {
  return (
    <div className="static xl:bottom-[8.438rem] left-1/2 z-50 mx-auto mt-14 sm:mt-0 flex w-80 items-center justify-center sm:absolute 2xl:w-[34.6rem] sm:-translate-x-1/2 sm:w-115 md:bottom-16 sm:bottom-20">
